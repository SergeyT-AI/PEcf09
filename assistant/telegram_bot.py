...
Я отвечаю по материалам урока: основы Python, векторный поиск и RAG. Спрашивайте, что такое Python, как хранятся эмбеддинги и как ассистент находит фрагменты в документах.
...
• Вопрос идёт в базу знаний урока (Python, векторные базы, RAG)
